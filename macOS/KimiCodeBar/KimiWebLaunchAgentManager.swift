  ...
  private func generatePlist(kimiPath: String) -> Data {
    let plist: [String: Any] = [
      ...
      "EnvironmentVariables": [
        "PATH":
          "/usr/local/bin:/usr/bin:/bin:/usr/sbin:/sbin:/opt/homebrew/bin:\(FileManager.default.homeDirectoryForCurrentUser.path)/.kimi-code/bin:\(FileManager.default.homeDirectoryForCurrentUser.path)/.kimi/bin"
      ],
    ]
