...
final class KimiOAuthService {
  ...
  private static func identityHeaders() -> [String: String] {
    var headers: [String: String] = [
      ...
      "X-Msh-Version": Bundle.main.infoDictionary?["CFBundleShortVersionString"] as? String
        ?? "1.0.0",
    ]
  ...
  private static func tokenFromResponse(_ data: Data, fallbackRefreshToken: String? = nil) throws
    -> KimiOAuthToken
  {
